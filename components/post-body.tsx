...
export default function PostBody({
  ...
  let imagesWithIntro = [fiveXThousandImage, project.bannerImage].concat(
    images
  );
  ...
  const section1: Document = {
    content: content.json.content.slice(0, 2),
    data: {},
    nodeType: BLOCKS.DOCUMENT,
  };
  const section2: Document = {
    content: content.json.content.slice(2, 4),
    data: {},
    nodeType: BLOCKS.DOCUMENT,
  };
  const section3: Document = {
    content: content.json.content.slice(4),
    data: {},
    nodeType: BLOCKS.DOCUMENT,
  };
    ...
    <Container>
        ...
        <div className="grid grid-cols-1 gap-y-20">
          ...
          <div className="place-self-left text-right">
            ...
            <div className="flex flex-row justify-between">
              <h2 className="text-2xl font-light text-gray-400 text-left">
                {project.projectLocation}
              </h2>
              <h2 className="text-2xl font-light text-gray-400">
                {project.projectSubtitle == null ? (
                  <DateComponent dateString={project.dateCreated} />
                ) : (
            ...
            <br />
            <h2 className="text-lg text-left font-light">
      ...
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-10">
        <div className={markdownStyles["markdown"]}>
          {documentToReactComponents(section1, customMarkdownOptions(content))}
          {images.length > 0 && (
            <div>
              <ContentfulImage
                width={BODY_IMAGE_WIDTH}
          ...
          {documentToReactComponents(section3, customMarkdownOptions(content))}
          {images.length > 2 && (
            <div>
              <ContentfulImage
                width={BODY_IMAGE_WIDTH}
        ...
        <div className={markdownStyles["markdown"]}>
          ...
          {documentToReactComponents(section2, customMarkdownOptions(content))}
          {images.length > 3 && (
            <div>
              <ContentfulImage
                width={BODY_IMAGE_WIDTH}
