    ...
    <Container>
      <nav className="flex items-center justify-between flex-wrap py-6">
        ...
        <div className="block lg:hidden">
          <button
            className="flex items-center px-3 py-2 border rounded hover:text-grey hover:border-slate-600"
            onClick={() => {
              setOpen(!navOpen);
            }}
          >
        ...
        {navOpen && (
          <div className="lg:hidden w-full block flex-grow lg:items-center lg:w-auto">
