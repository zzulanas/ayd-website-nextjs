export default function Intro({ introActionItem }) {
  return (
    <section className="flex-col md:flex-col flex items-left md:justify-between md:mt-16 mb-16 md:mb-12">
      ...
      {introActionItem.displayText && introActionItem.link ? (
        <a href={introActionItem.link} className="text-blue-500 hover:underline">
