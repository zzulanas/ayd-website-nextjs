...
export const BODY_IMAGE_WIDTH = 800
export const BODY_IMAGE_HEIGHT = 800

export const OG_DESCRIPTION = "AyD is an architecture and design studio based in Los Angeles, California."